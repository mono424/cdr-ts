import { parseCDR, parseInt, parseUint, parseUintToBigInt } from "./parser";
import { createArrayBuffer } from "./buffer";
import { CDRSchema, CDRSchemaDictionaryField, CDRSchemaDictionaryValue, CDRSchemaIntValue, CDRSchemaSequenceValue, CDRSchemaStringValue, CDRSchemaUintValue } from "./schema";
...
test("Parse Video Frame Schema Message", () => {
  ...
  const parsed = parseCDR(data, cameraPacketSchema, {maxSequenceSize: 10000});
